...
} elseif ($mod == 'alternatif_search') {
    $q = $_POST['q'];

    // Sesuaikan query SQL untuk mencocokkan nilai pencarian
    $result = $db->get_results("SELECT * FROM tb_alternatif WHERE kode_alternatif LIKE '%$q%' OR nama_alternatif LIKE '%$q%' OR keterangan LIKE '%$q%'");
    ...
    if ($result) {
        ...
        foreach ($result as $row) {
            ...
            echo "<tr>
                    ...
                    <td>
                        <a href='aksi.php?act=alternatif_hapus&ID=$row->kode_alternatif'>Hapus</a>
                    </td>
                </tr>";
        }
