<?php
$fuzzy = new Fuzzy(get_aturan(), get_relasi(), get_hasil_option($selected),get_himpunan_option($nilai, $aturan));
$fuzzy->calculate();
$data = get_relasi();
$nilai = get_hasil_option($data);
$aturan = get_aturan();
$min = get_himpunan_option($nilai, $aturan);

//$total = get_total($aturan, $min);

?>
<div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">Nilai Alternatif</h3></div>
    <div class="oxa">
